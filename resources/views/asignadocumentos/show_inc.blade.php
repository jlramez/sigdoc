    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header"><h3>Documentos de las actuaciones de la incidencia <b>{{$asignadocumento->folio}}-INC</b></h3></div>
                    ...
                    <div class="card-body">
                        ...
                        <tbody align="center">
                            @foreach($ad as $adoc)
                                ...
                                <td width="350px">
                                <a href="/storage/estrados/2021/{{$asignadocumento->folio}}/incidencia/{{$adoc->documentos->nombre_dcto}}" target="_blank"class="btn btn-outline-primary"><i class="fas fa-file-pdf"></i> Descargar</a>
                ...
                <a href="{{route ('incidencias.index')}}" class="btn btn-primary"><i class="fas fa-backward">  </i> Regresar</a>
