    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header"><h3>Adjuntar documentos Incidencias</h3></div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('documentos.store_atach_inc', $expedientes->id) }}" enctype="multipart/form-data">
                        @csrf
            ...
            <a href="{{route('asignadocumentos.show_inc', $expedientes->id)}}" class="btn btn-primary"><i class="fas fa-backward"></i> Regresar</a>
            </div> 
            </div>
        </div>
    </div>
